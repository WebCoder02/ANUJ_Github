...
<head>
    ...
    <title>TeyZee Visas - Morocco Visa Services</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/morocco.jpg" alt="Morocco">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=morocco&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=morocco&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Morocco_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
    ...
    <div class="visa-cards-grid">
        ...
        <a href="/payments/payment.php?country=morocco&amount=7799"><button class="apply-button">Apply Now for $90.80 (₹7300 + ₹499)</button></a>
        </div>
        ...
        <a href="/payments/payment.php?country=morocco&amount=10999"><button class="apply-button">Apply Now for $128.13 (₹10,500 + ₹499) </button></a>
        </div>
                ...
                <div class="process-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content result">
                            ...
                            <p>From the appointment date, get your visa in <span class="highlight">1-3 days</span>.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Morocco Visa</h2>
            <p class="subtitle">Curated resources for Morocco visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Morocco Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Morocco visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Morocco Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Morocco Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Morocco. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Morocco Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Morocco</h3>
                        <p>Both single and multiple-entry visas available for Morocco travel. <span
