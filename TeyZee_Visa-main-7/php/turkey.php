...
<head>
    ...
    <title>TeyZee Visas - Turkey Visa Services</title>
            ...
            <div class="hero-content">
                ...
                <div class="stats">
                    <div class="stat">
                        ...
                        <span class="stat-text">Approval Rate</span>
                    </div>
                </div>
            </div>
            <div class="hero-image">
                <img src="../VisaImages/destinations/turkey.jpg" alt="Paris cityscape">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=turkey&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
   <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=turkey&amp;amount=499" class="check-btn">Download Documents</a>
...
<section class="visa-cards-wrapper" id="eVisa">
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <a href="/payments/payment.php?country=turkey&amount=4699"><button class="apply-button">Apply Now for $49 (₹4,200 + ₹499)</button></a>
    </div>
            ...
            <div class="visa-card">
                ...
                <div class="visa-action">
                    <div class="price">
                        ...
                        <h3>217.47$ per adult</h3>
                        <!-- <a href="#">View details</a> -->
                    </div>
                    <a href="/payments/payment.php?country=turkey&amount=19199"><button class="start-btn">Apply Now</button></a>
                </div>
            </div>
            ...
            <div class="process-steps">
                ...
                <div class="step">
                    ...
                    <div class="step-content result">
                        ...
                        <p>From the appointment date, get your visa in <span class="highlight">28 days</span>.</p>
                    </div>
                </div>
            </div>
...
<section class="process">
            ...
            <div class="process-steps">
                ...
                <div class="step">
                    ...
                    <div class="step-content result">
                        ...
                        <p>From the appointment date, get your visa in <span class="highlight">1 day</span>.</p>
                    </div>
                </div>
            </div>
    ...
    <!-- <div class="checklist-header">
                <h3>Documents required for <span class="flag"> </span> Turkey Visa</h3>
                <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Turkey Checklist</a>
            </div> -->
    <!-- <div class="checklist-column">
    ...
    <!-- <h4>Mandatory Docs</h4>
                ...
                <section class="info-cards" id="info-section">
                    <div class="container">
                        <h2>Know more about Turkey visa</h2>
                        <p class="subtitle">Curated resources for Turkey visa</p>
                        <div class="info-grid">
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Turkey Visa Rejection Rates & Prevention Tips</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>How do I prevent my Turkey visa application from being  denied?</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>When to Apply for a Turkey Visa: Optimal Timing</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Turkey Transit Visa Requirements for Indian Citizens</h3>
                                    <p>Indian citizens need a transit visa for all layovers in Turkey. <span class="hidden-content">This visa only allows airport stays - for city visits, apply for a regular  visa.</span></p>
                                    <a href="#" class="read-more">Read more <i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Reapplying After Turkey Visa Rejection: Next Steps</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Single vs. Multiple-Entry  Visas for Turkey</h3>
                                    <p>Both single and multiple-entry visas available for Turkey travel. <span class="hidden-content">First-time visitors should apply for single-entry, while multiple-entry allows unlimited visits within the validity period.</span></p>
                                    <a href="#" class="read-more">Read more <i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- <section class="related-countries">
        <div class="container">
            ...
            <p class="subtitle">Users who looked for Turkey, also looked at these countries</p>
    ...
    <!-- <section class="faq">
        <div class="container">
            <h2>FAQs for Turkey Visa</h2>
            
            <div class="faq-list">
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What should I do if my Turkey visa application is denied as an Indian citizen?</h3>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Do Indian citizens need a transit visa when traveling to Turkey?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Do I need to courier my document for an e-visa for Turkey as an Indian?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>When to apply for Turkey visa as an Indian?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Is Turkey visa multiple entry?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What is the rejection rate for Turkey visa for Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Is it possible to extend the validity of my Turkey visa as an Indian citizen?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>How long can I stay in Turkey with my tourist visa?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What is the processing time for Turkey tourist visa?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What are the steps and procedures for obtaining a Turkey visa for Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Where to track my Turkey visa application status?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Does Turkey offer visa on arrival to Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
            </div>
