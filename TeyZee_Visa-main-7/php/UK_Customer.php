            ...
            <td>
                        ...
                        <?php else: ?>
                            <p>
                                ...
                                <a href="https://teyzeevisas.com/php/payment.php?country=UK_Customer&amount=499" class="doc-link-special">Check Eligibility</a><br>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="https://teyzeevisas.com/php/login.php?country=UK_Customer" class="doc-link-special">Login</a>
                            </p>
                        <?php endif; ?>
