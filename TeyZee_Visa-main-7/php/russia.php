...
<head>
    ...
    <title>TeyZee Visas - Russia Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/russia.jpg" alt="Russia">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=russia&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=russia&amp;amount=499" class="check-btn">Download Documents</a>
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        ...
        <div><strong>Visa Duration:</strong> 60 days from issue</div>
        <div><strong>Length of Stay:</strong> Up to 16 days</div>
        
      </div>
      <a href="/payments/payment.php?country=russia&amount=4899"><button class="apply-button">Apply Now for $57.06 (₹4400 + ₹499)</button></a>
    </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Russia Visa</h2>
            <p class="subtitle">Curated resources for Russia visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Russia Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Russia visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Russia Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Russia Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Russia. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Russia Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Russia</h3>
                        <p>Both single and multiple-entry visas available for Russia travel. <span
