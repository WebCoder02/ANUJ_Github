                ...
                <tr>
                  ...
                  <td>Duly filled application form <br>
                    <span class="special-doc">Login to see the Visa Application form and the Document Checklist.</span>
                              ...
                              <a href="https://india.mid.ru/en/consular-affairs/visa/"class="doc-link-special">Download Application Form</a>
                              <a href="https://evisacheck.kdmid.ru/"class="doc-link-special">Download Document Checklist</a>
                              <?php else: ?>
                            <p>
                                ...
                                ?>
                                <a href="/payments/payment.php?country=russia&visa_type=eligibility_check"><button id="check-now" class="doc-link-special">Check Eligibility - Pay ₹499</button></a>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="/php/login.php?country=Russia_Customer" class="doc-link">Login</a>
                            </p>
                              <?php endif; ?>  
                  </td>
                </tr>
