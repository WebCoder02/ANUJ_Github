...
<body>
    ...
    <h1>Malta Schengen Visa Checklist</h1>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Malta Tourist Visa Checklist </h2>
            <table>
                <tr>
                    ...
                    <td>Application Form duly filled in and signed by the applicant
                        ...
                        <?php else: ?>
                            ...
                            <p>
                                ...
                                <a href="https://teyzeevisas.com/php/payment.php?country=Malta_Customer&amount=499" class="doc-link-special">Check Eligibility</a><br>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="https://www.teyzeevisas.com/php/login.php?redirect_to=/php/Malta_Customer.php" class="doc-link-special">Login</a>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
        ...
        <div id="business" class="tabcontent">
            <h2>Malta Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent"><h2>This Information is available only to users who have logged in.</h2>             <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Malta, Malta, Malta, Croatia, Malta, Malta,
                        Malta, France, Germany, Greece, Malta, Malta, Italy, Malta, Liechtenstein, Malta,
                        Malta, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Malta, and
                        Switzerland.</td>
                </tr>
                <tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Malta- https://teyzee.com/malta.php; please type the 7 digit receipt no in your next whatsapp message to us`;
