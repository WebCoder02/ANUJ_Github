    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=cambodia&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=cambodia&amp;amount=499" class="check-btn">Download Documents</a>
    ...
    <section class="next-appointment">
     ...
     <section class="visa-cards-wrapper" id="eVisa">
        ...
        <div class="visa-cards-grid">
            ...
            <a href="/payments/payment.php?country=cambodia&amount=3199"><button class="apply-button">Apply Now @ $31$ (₹2700+₹499 )</button></a>
            </div>
