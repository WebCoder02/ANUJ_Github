...
<head>
    ...
    <title>TeyZee Visas - Cambodia Visa Services</title>
...
<?php endif; ?>
    ...
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/php/Cambodia_Customer.php" class="check-btn">Download Documents</a>
     ...
     <section class="visa-cards-wrapper" id="eVisa">
        ...
        <div class="visa-cards-grid">
            ...
            <div class="visa-information">
                ...
                <div><strong>Processing Time:</strong> 6 working days</div>
                <div><strong>Visa Duration:</strong> 90 days from issue</div>
                <div><strong>Length of Stay:</strong> Up to 30 days</div>
            </div>
            <?php if (isset($_SESSION['user_id'])): ?>
            <a href="/payments/payment.php?country=cambodia&visa_type=tourist_single"><button class="apply-button">Apply Now for $31 (₹2700 + ₹499)</button></a>
        <?php else: ?>
            <a href="/payments/payment.php?country=cambodia&visa_type=tourist_single&redirect_to=/php/cambodia.php"><button class="apply-button">Apply Now for $31 (₹2700 + ₹499)</button></a>
        <?php endif; ?>
            </div>
                ...
                <div class="process-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content result">
                            ...
                            <p>From the appointment date, get your visa in <span class="highlight">6 days</span>.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Cambodia Visa</h2>
            <p class="subtitle">Curated resources for Cambodia visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Cambodia Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Cambodia visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Cambodia Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Cambodia Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Cambodia. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Cambodia Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Cambodia</h3>
                        <p>Both single and multiple-entry visas available for Cambodia travel. <span
