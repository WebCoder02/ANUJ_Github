...
.apply-button:hover {
  background-color:rgb(115, 104, 207);
  transform: translateY(-2px);
}

.apply-button:active {
  transform: translateY(0);
  box-shadow: 0 2px 4px rgba(94, 26, 110, 0.3);
}
    </style>
...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=azerbaijan&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/payments/payment.php?country=azerbaijan&amp;amount=499" class="check-btn">Download Documents</a>
  ...
  <h2 class="visa-information-title">Visa Information</h2>

  <div class="visa-cards-grid">

    <div class="visa-cards">
      <h3 class="visa-title">Single Entry</h3>
      ...
      <a href="/payments/payment.php?country=egypt&amount=499"><button class="apply-button">Apply Now @ $₹2899</button>
    </div>

    <div class="visa-cards">
      <h3 class="visa-title">Express Entry</h3>
      <div class="visa-information">
        <div><strong>Visa Type:</strong> eVisa</div>
      ...
      <a href="/payments/payment.php?country=egypt&amount=499"><button class="apply-button">Apply Now @ $₹6799 </button>
    </div>
    ...
    <section class="next-appointment">
            ...
            </section> <section class="visa-types">
        <div class="container">
            ...
            <div class="visa-card">
                ...
                <div class="visa-action">
                    ...
                    <a href="/payments/payment.php?country=china&amount=499"><button class="start-btn">Apply Now</button></a>
                </div>
            </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            ...
            <div class="info-grid">
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for Azerbaijan</h3>
