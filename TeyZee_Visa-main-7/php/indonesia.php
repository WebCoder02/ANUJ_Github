...
<head>
    ...
    <title>TeyZee Visas - Indonesia Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/indonesia.jpg" alt="Indonesia">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=indonesia&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=indonesia&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Indonesia_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
...
<section class="visa-cards-wrapper" id="eVisa">
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <a href="/payments/payment.php?country=indonensia&amount=3299"><button class="apply-button">Apply Now for $33 (₹2800 + ₹499)</button></a>
    </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Indonesia Visa</h2>
            <p class="subtitle">Curated resources for Indonesia visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Indonesia Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Indonesia visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Indonesia Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Indonesia Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Indonesia. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Indonesia Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Visas for Indonesia</h3>
                        <p>Both single and multiple-entry visas available for Indonesia travel. <span
