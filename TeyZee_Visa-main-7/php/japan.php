...
<head>
    ...
    <title>TeyZee Visas - Japan Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/japan.jpg" alt="Paris cityscape">
    ...
    <section class="visa-eligibility">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="J/payments/payment_visas.php?country=japan&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
   <section class="document-checklist">
        <div class="container">
            <div class="label-container">
                ...
                <a href="japan_customer.html" target="_blank">Download the Documentation</a>
            </div>
...
<section class="process">
    ...
    <!-- <div class="checklist-header">
                <h3>Documents required for <span class="flag"> </span> Japan Visa</h3>
                <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Japan Checklist</a>
            </div> -->
    <!-- <div class="checklist-column">
                        ...
                        <div class="info-grid">
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Japan Visa Rejection Rates & Prevention Tips</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>How do I prevent my Japan visa application from being  denied?</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>When to Apply for a Japan Visa: Optimal Timing</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Reapplying After Japan Visa Rejection: Next Steps</h3>
    ...
    <!-- <section class="related-countries">
        <div class="container">
            ...
            <p class="subtitle">Users who looked for Japan, also looked at these countries</p>
    ...
    <!-- <section class="faq">
        <div class="container">
            <h2>FAQs for Japan Visa</h2>
            
            <div class="faq-list">
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What should I do if my Japan visa application is denied as an Indian citizen?</h3>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Do Indian citizens need a transit visa when traveling to Japan?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Do I need to courier my document for an e-visa for Japan as an Indian?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>When to apply for Japan visa as an Indian?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Is Japan visa multiple entry?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What is the rejection rate for Japan visa for Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Is it possible to extend the validity of my Japan visa as an Indian citizen?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>How long can I stay in Japan with my tourist visa?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What is the processing time for Japan tourist visa?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What are the steps and procedures for obtaining a Japan visa for Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Where to track my Japan visa application status?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Does Japan offer visa on arrival to Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
            </div>
