    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment_visas.php?country=brazil&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
            ...
            <div class="info-grid">
                ...
                <div class="info-card">
                    <div class="card-content">
                        ...
                        <p>Indian citizens need a transit visa for all layovers in Brazil. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for Brazil</h3>
                        <p>Both single and multiple-entry visas available for Brazil travel. <span
