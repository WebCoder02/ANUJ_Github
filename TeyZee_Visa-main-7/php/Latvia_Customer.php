            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Visa application form completed online, printed and signed by the applicant.
                        ...
                        <a href="https://epak.pmlp.gov.lv/NVIS.EService001.WebSite/ApplicationMain.aspx?" class="doc-link-special">Download Application Form</a>
                        <a href="https://www.vfsglobal.com/latvia/india/pdf/Visit_Family_And_Friend_visa_Checklist.pdf" class="doc-link-special">Download Document Checklist</a>
                        <?php else: ?>
                            ...
                            <p>
                                ...
                                ?>
                                <a href="/payments/payment.php?country=latvia&visa_type=eligibility_check"><button id="check-now" class="doc-link-special">Check Eligibility - Pay ₹499</button></a>
                                <br>Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="https://www.teyzeevisas.com/php/login.php?redirect_to=/php/Latvia_Customer.php" class="doc-link-special">Login</a>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Latvia- https://teyzee.com/latvia.php; please type the 7 digit receipt no in your next whatsapp message to us`;
