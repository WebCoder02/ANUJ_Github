    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            ...
            <table>
                ...
                <tr>
                    <td>Cover Letter</td>
                    <td>Required on company letterhead (if proprietor). Must mention names, dates, purpose, expenses bearer <a href="/templates/cover_letter_template.doc"
                ...
                <tr>
                    ...
                    <td>Lettera d’invito + sponsor ID document <a
