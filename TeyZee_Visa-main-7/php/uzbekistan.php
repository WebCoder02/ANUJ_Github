...
<head>
    ...
    <title>TeyZee Visas - Uzbekistan Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-text">
                    <h1>Get your Uzbekistan visa</h1>
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/uzbekistan.jpg" alt="Uzbekistan">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=uzbekistan&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=uzbekistan&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Uzbekistan_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
 ...
 <section class="visa-cards-wrapper">
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <a href="/payments/payment.php?country=uzbekistan&amount=2449"><button class="apply-button">Apply Now for $29 (₹1950 + ₹499)</button></a>
    </div>

    <div class="visa-cards">
      <h3 class="visa-title">Double Entry (ETA - Electronic Travel Authorisation)</h3>
      <div class="visa-information">
        <div><strong>Visa Type:</strong> eVisa</div>
        <div><strong>Processing Time:</strong> 5 working days</div>
        <div><strong>Visa Duration:</strong> 90 days from issue</div>
      ...
      <a href="/payments/payment.php?country=uzbekistan&amount=3549"><button class="apply-button">Apply Now for $42 (₹3050 + ₹499)</button></a>
    </div>
    ...
    <div class="visa-cards">
      ...
      <a href="/payments/payment.php?country=uzbekistan&amount=4849"><button class="apply-button">Apply Now for $57 (₹4350 + ₹499) </button></a>
    </div>
                ...
                <div class="process-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content result">
                            ...
                            <p>From the appointment date, get your visa in <span class="highlight">5 working days</span>.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Uzbekistan Visa</h2>
            <p class="subtitle">Curated resources for Uzbekistan visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Uzbekistan Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Uzbekistan visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Uzbekistan Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Uzbekistan Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Uzbekistan. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Uzbekistan Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Uzbekistan</h3>
                        <p>Both single and multiple-entry visas available for Uzbekistan travel. <span
