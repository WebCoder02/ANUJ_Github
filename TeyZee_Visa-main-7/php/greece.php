...
<head>
    ...
    <title>TeyZee Visas - Greece Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/greece.jpg" alt="Paris cityscape">
    ...
    <section class="visa-eligibility">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment_visas.php?country=greece&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
   <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/payments/payment.php?country=greece&amp;amount=499" class="check-btn">Download Documents</a>
...
<section class="process">
    ...
    <!-- <div class="checklist-header">
                <h3>Documents required for <span class="flag"> </span> Greece Visa</h3>
                <a href="#" class="download-btn"><i class="fas fa-download"></i> Download Greece Checklist</a>
            </div> -->
    <!-- <div class="checklist-column">
    ...
    <!-- <h4>Mandatory Docs</h4>
                ...
                <section class="info-cards">
                    <div class="container">
                        <h2>Know more about Greece visa</h2>
                        <p class="subtitle">Curated resources for Greece visa</p>
                        <div class="info-grid">
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Greece Visa Rejection Rates & Prevention Tips</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>How do I prevent my Greece visa application from being  denied?</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>When to Apply for a Greece Visa: Optimal Timing</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Greece Transit Visa Requirements for Indian Citizens</h3>
                                    <p>Indian citizens need a transit visa for all layovers in Greece. <span class="hidden-content">This visa only allows airport stays - for city visits, apply for a regular Schengen visa.</span></p>
                                    <a href="#" class="read-more">Read more <i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Reapplying After Greece Visa Rejection: Next Steps</h3>
                            ...
                            <div class="info-card">
                                <div class="card-content">
                                    <h3>Single vs. Multiple-Entry Schengen Visas for Greece</h3>
                                    <p>Both single and multiple-entry visas available for Greece travel. <span class="hidden-content">First-time visitors should apply for single-entry, while multiple-entry allows unlimited visits within the validity period.</span></p>
                                    <a href="#" class="read-more">Read more <i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- <section class="related-countries">
        <div class="container">
            ...
            <p class="subtitle">Users who looked for Greece, also looked at these countries</p>
    ...
    <!-- <section class="faq">
        <div class="container">
            <h2>FAQs for Greece Visa</h2>
            
            <div class="faq-list">
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What should I do if my Greece visa application is denied as an Indian citizen?</h3>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Do Indian citizens need a transit visa when traveling to Greece?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Do I need to courier my document for an e-visa for Greece as an Indian?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>When to apply for Greece visa as an Indian?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Is Greece visa multiple entry?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What is the rejection rate for Greece visa for Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Is it possible to extend the validity of my Greece visa as an Indian citizen?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>How long can I stay in Greece with my tourist visa?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What is the processing time for Greece tourist visa?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>What are the steps and procedures for obtaining a Greece visa for Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Where to track my Greece visa application status?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <h3>Does Greece offer visa on arrival to Indians?</h3>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                </div>
            </div>
