...
<head>
    ...
    <title>Denmark Visa Checklist</title>
...
<body>
    ...
    <h1>Denmark Schengen Visa Checklist</h1>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Denmark Tourist Visa Checklist </h2>
            <table>
                <tr>
                    ...
                    <td>Application form completely filled, printed and signed by the applicant <br>
                        ...
                        <span class="special-doc">Login to see the Visa Application form and the Document Checklist.</span>
                            <p>
                                ...
                                <a href="https://teyzeevisas.com/php/payment.php?country=Denmark_Customer&amount=499" class="doc-link-special">Check Eligibility</a><br>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="https://www.teyzeevisas.com/php/login.php?redirect_to=/php/Denmark_Customer.php" class="doc-link-special">Login</a>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Visa Fee payment receipt printed from <a href="https:applyvisa.um.dk/" target="_blank">https:applyvisa.um.dk/</a></td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>One recent (less than six months old) passport-size photograph in color with good resemblance. (3.5cm / 4.5cm)</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>Passport, should be valid for at least three months (any other type of travel document should be valid for at least six months), beyond the intended duration of stay in Schengen and with at least two blank pages.</td>
                </tr>
                <tr>
                    <td>5</td>
                    <td>Overseas travel medical insurance valid for all Schengen-countries. The insurance must cover at least 30,000 Euros for all risks e.g. accident, illness, medical emergency evacuation, Covid-19 etc., and must clearly specify the validity period covering the entire trip.</td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>Certificate of the travel agency confirming the booking of an organized trip or other appropriate document indicating the travel plans.</td>
                </tr>
                <tr>
                    <td>7</td>
                    <td>Flight reservations of return or round ticket. If traveling to several Schengen states, include intra-Schengen travel proof (flight/train/car rental). Cruise travelers must provide ticket & payment receipt. Avoid purchasing flight tickets before visa approval.</td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>Proof of accommodation: Hotel bookings or accommodation guarantees covering the whole duration of the intended stay.</td>
                </tr>
                <tr>
                    <td>9</td>
                    <td>Marriage Certificate:<br>
                        • If travelling with spouse – copy of marriage certificate if not shown in passport;<br>
                        • Copy of ration card, if applicable.</td>
                </tr>
                <tr>
                    <td>10</td>
                    <td>In case of minors (&lt; 18 years) traveling:<br>
                        • If with one parent, notarized written consent of the other;<br>
                        • If alone, notarized consent from both parents/guardians;<br>
                        • Photocopy of both parents’ passports or ID cards with signature;<br>
                        • Photocopy of birth certificate.</td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>Original personal bank statement (last 3 months) with applicant's name, stamped and signed by bank:<br>
                        • Required for all applicants, even if sponsored;<br>
                        • Must show sufficient funds: DKK 350/day (private stay), DKK 500/day (hotel).<br>
                        More info at: <a href="http:www.nyidanmark.dk" target="_blank">www.nyidanmark.dk</a></td>
                </tr>
                <tr>
                    <td>12</td>
                    <td>Evidence of source of financial support:<br>
                        • Indian income tax return acknowledgment for last 2 assessment years</td>
                </tr>
                <tr>
                    <td>13</td>
                    <td>If employed:<br>
                        • Last 3 months’ payslips;<br>
                        • Employment contract AND leave approval letter from employer.</td>
                </tr>
                <tr>
                    <td>14</td>
                    <td>If company owner/self-employed:<br>
                        • Certificate of company registration.</td>
                </tr>
                <tr>
                    <td>15</td>
                    <td>If sponsored:<br>
                        • Proof of sponsorship;<br>
                        • Sponsorship letter;<br>
                        • Sponsor’s photo ID (passport, Aadhaar, or driver’s license).</td>
                </tr>
                <tr>
                    <td>16</td>
                    <td>If retired:<br>
                        • Pension statements for last 3 months;<br>
                        • Proof of regular income from property/business.</td>
                </tr>
            </table>
        </div>

        <div id="business" class="tabcontent">
            <h2>Denmark Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Denmark, Denmark, Denmark, Croatia, Denmark, Estonia,
                        Finland, France, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Denmark, and
                        Switzerland.</td>
                </tr>
                <tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Denmark- https:teyzee.com/denmark.php; please type the 7 digit receipt no in your next whatsapp message to us`;
