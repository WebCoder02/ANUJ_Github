...
<head>
    ...
    <title>TeyZee Visas - Armenia Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/armenia.jpg" alt="armenia">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=armenia&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="Armenia_/payments/payment.php?country=Armenia&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Armenia_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        <div><strong>Visa Type:</strong> eVisa</div>
        <div><strong>Processing Time:</strong> 3 working days</div>
        <div><strong>Visa Duration:</strong> 120 days from issue</div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Armenia Visa</h2>
            <p class="subtitle">Curated resources for Armenia visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Armenia Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Armenia visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Armenia Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Armenia Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Armenia. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Armenia Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Visas for Armenia</h3>
                        <p>Both single and multiple-entry visas available for Armenia travel. <span
