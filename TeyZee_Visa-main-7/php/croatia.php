...
<head>
    ...
    <title>TeyZee Visas - Croatia Visa Services</title>
...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment_visas.php?country=croatia&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Croatia Visa</h2>
            <p class="subtitle">Curated resources for Croatia visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Croatia Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Croatia visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Croatia Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Croatia Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Croatia. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Croatia Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for Croatia</h3>
                        <p>Both single and multiple-entry visas available for Croatia travel. <span
