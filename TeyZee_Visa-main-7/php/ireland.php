...
<head>
    ...
    <title>TeyZee Visas - Ireland Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/ireland.jpg" alt="Ireland">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=ireland&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/php/Ireland_Customer.php" class="check-btn">Download Documents</a>
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        ...
        <div><strong>Processing Time:</strong> 10 working days</div>
        <div><strong>Visa Duration:</strong> 180 days from issue</div>
        <div><strong>Length of Stay:</strong> Up to 180 days</div>
        
      </div>
      <a href="/payments/payment.php?country=ireland&amount=9899"><button class="apply-button">Apply Now for $115.31 (₹9400 + ₹499)</button></a>
    </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Ireland Visa</h2>
            <p class="subtitle">Curated resources for Ireland visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Ireland Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Ireland visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Ireland Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Ireland Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Ireland. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Ireland Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Ireland</h3>
                        <p>Both single and multiple-entry visas available for Ireland travel. <span
