...
<head>
    ...
    <title>TeyZee Visas - Vietnam Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/vietnam.jpg" alt="Vietnam">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=vietnam&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=vietnam&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Vietnam_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        ...
        <div><strong>Visa Duration:</strong> 30 days from issue</div>
        <div><strong>Length of Stay:</strong> Up to 30 days</div>
        
      </div>
      <a href="/payments/payment.php?country=vietnam&amount=2819"><button class="apply-button">Apply Now for $27 (₹2,320+ ₹499)</button></a>
    </div>

    <div class="visa-cards">
      <h3 class="visa-title">Single Express Entry (ETA - Electronic Travel Authorisation)</h3>
      <div class="visa-information">
        <div><strong>Visa Type:</strong> eVisa</div>
      ...
      <a href="/payments/payment.php?country=vietnam&amount=10399"><button class="apply-button">Apply Now for $115 (₹9,900+ ₹499) </button></a>
    </div>
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        <div><strong>Visa Type:</strong> eVisa</div>
        <div><strong>Processing Time:</strong> 7 working days</div>
        <div><strong>Visa Duration:</strong> 30 days from issue</div>
        <div><strong>Length of Stay:</strong> Up to 30 days</div>
        
      </div>
      <a href="/payments/payment.php?country=vietnam&amount=5229"><button class="apply-button">Apply Now for $55 (₹4,730+ ₹499)</button></a>
    </div>

    <div class="visa-cards">
      <h3 class="visa-title">Multiple Express Entry (ETA - Electronic Travel Authorisation)</h3>
      <div class="visa-information">
        <div><strong>Visa Type:</strong> eVisa</div>
        <div><strong>Processing Time:</strong> 5 working hours</div>
        <div><strong>Visa Duration:</strong> 30 days from issue</div>
        <div><strong>Length of Stay:</strong> Up to 30 days</div>
      </div>
      <a href="/payments/payment.php?country=vietnam&amount=12299"><button class="apply-button">Apply Now for $138 (₹11,800+ ₹499) </button></a>
    </div>
                ...
                <div class="process-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content result">
                            ...
                            <p>From the appointment date, get your visa in <span class="highlight">1-7 days</span>.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Vietnam Visa</h2>
            <p class="subtitle">Curated resources for Vietnam visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Vietnam Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Vietnam visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Vietnam Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Vietnam Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Vietnam. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Vietnam Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for Vietnam</h3>
                        <p>Both single and multiple-entry visas available for Vietnam travel. <span
