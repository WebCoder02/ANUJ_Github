...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment_visas.php?country=southKorea&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    <section class="document-checklist">
        <div class="container">
            <div class="label-container">
                ...
                <a href="South_Korea_Customer.html" target="_blank">Download the Documentation</a>
            </div>
            <!-- <div class="label-container">
    ...
    <section class="visa-types">
        <div class="container">
            <h2>Types of South Korea Visa</h2>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            ...
            <div class="info-grid">
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for South Korea</h3>
