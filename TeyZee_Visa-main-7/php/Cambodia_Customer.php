            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Visa application form duly completed, dated and signed by the applicant
                        ...
                        <a href="https://www.embassyofcambodiadc.org/uploads/9/8/1/8/98182996/cambodiatouristvisaform.pdf"class="doc-link-special">Download Application Form</a>
                        <a href="https://www.evisa.gov.kh/information/visa_type/4"class="doc-link-special">Download Document Checklist</a>
                        <?php else: ?>
                            <p>
                                ...
                                ?>
                                <a href="/payments/payment.php?country=cambodia&visa_type=eligibility_check"><button id="check-now" class="doc-link-special">Check Eligibility - Pay ₹499</button></a>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="/php/login.php?country=Cambodia_Customer" class="doc-link">Login</a>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
