            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Application form duly completed, dated and signed by the applicant.
                        ...
                        <a href="https://www.immd.gov.hk/eng/services/index.html#tab_a_1"class="doc-link-special">Download Application Form</a>
                        <a href="https://www.immd.gov.hk/eng/service/travel_document/Application_for_HKSAR_Document_of_Identity_for_Visa_Purposes.html#a&secondTab"class="doc-link-special">Download Document Checklist</a>
                        <?php else: ?>
                            <p>
                                ...
                                ?>
                                <a href="/payments/payment.php?country=hong_kong&visa_type=eligibility_check"><button id="check-now" class="doc-link-special">Check Eligibility - Pay ₹499</button></a>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="/php/login.php?country=Hong_Kong_Customer" class="doc-link">Login</a>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
