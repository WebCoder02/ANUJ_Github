    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            ...
            <table>
                ...
                <tr>
                    <td>4</td>
                    <td>Valid Bulgaria or Macau ID-card and residence permit (if not a permanent resident) must be valid at least 3 months after the departure from the Schengen area.</td>
                </tr>
                <tr>
                    <td>5</td>
