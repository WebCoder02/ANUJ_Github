                    ...
                    <td>Application form fully filled<br>
                        ...
                        <span class="special-doc">Login to see the Visa Application form and the Document Checklist.</span>
                            <p>
                                ...
                                <a href="https://teyzeevisas.com/php/payment.php?country=Lithuania_Customer&amount=499" class="doc-link-special">Check Eligibility</a><br>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="https://www.teyzeevisas.com/php/login.php?redirect_to=/php/Lithuania_Customer.php" class="doc-link-special">Login</a>
                            </p>
                        <?php endif; ?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Introduction letter by Indian company on a company letterhead mentioning purpose of visit and
                        relationship between the Indian and the lithuanian company 
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Lithuania- https://teyzee.com/lithuania.php; please type the 7 digit receipt no in your next whatsapp message to us`;
