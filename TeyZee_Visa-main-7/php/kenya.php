...
<head>
    ...
    <title>TeyZee Visas - Kenya Visa Services</title>
...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment_visas.php?country=kenya&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/payments/payment.php?country=kenya&amp;amount=499" class="check-btn">Download Documents</a>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Kenya Visa</h2>
            <p class="subtitle">Curated resources for Kenya visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Kenya Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Kenya visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Kenya Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Kenya Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Kenya. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Kenya Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for Kenya</h3>
                        <p>Both single and multiple-entry visas available for Kenya travel. <span
