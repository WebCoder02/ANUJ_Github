...
<head>
    ...
    <title>TeyZee Visas - Bahrain Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/bahrain.jpg" alt="Bahrain">
...
<?php endif; ?>
     ...
     <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/php/Bahrain_Customer.php" class="check-btn">Download Documents</a>
    ...
    <div class="visa-cards-grid">
        ...
        <div class="visa-information">
            ...
            <div><strong>Processing Time:</strong> 9 working days</div>
            <div><strong>Visa Duration:</strong> 2 weeks from issue</div>
            <div><strong>Length of Stay:</strong> Up to 2 weeks</div>
            
        </div>
        <?php if (isset($_SESSION['user_id'])): ?>
            <a href="/payments/payment.php?country=bahrain&visa_type=tourist_single"><button class="apply-button">Apply Now for $29.19 (₹2000 + ₹499)</button></a>
        <?php else: ?>
            <a href="/payments/payment.php?country=bahrain&visa_type=tourist_single&redirect_to=/php/bahrain.php"><button class="apply-button">Apply Now for $29.19 (₹2000 + ₹499)</button></a>
        <?php endif; ?>
        </div>
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            <a href="/payments/payment.php?country=bahrain&visa_type=tourist_multiple"><button class="apply-button">Apply Now for $47.88 (₹3600 + ₹499)</button></a>
        <?php else: ?>
            <a href="/payments/payment.php?country=bahrain&visa_type=tourist_multiple&redirect_to=/php/bahrain.php"><button class="apply-button">Apply Now for $47.88 (₹3600 + ₹499)</button></a>
        <?php endif; ?>
        </div>
                ...
                <div class="process-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content result">
                            ...
                            <p>From the appointment date, get your visa in <span class="highlight">9 days</span>.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Bahrain Visa</h2>
            <p class="subtitle">Curated resources for Bahrain visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Bahrain Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Bahrain visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Bahrain Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Bahrain Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Bahrain. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Bahrain Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Visas for Bahrain</h3>
                        <p>Both single and multiple-entry visas available for Bahrain travel. <span
