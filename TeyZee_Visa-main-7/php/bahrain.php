...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=bahrain&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=bahrain&amp;amount=499" class="check-btn">Download Documents</a>
    ...
    <div class="visa-cards-grid">
        ...
        <a href="/payments/payment.php?country=bahrain&amount=2499"><button class="apply-button">Apply Now for $29.19 (₹2000 +₹499 )</button></a>
        </div>
        ...
        <a href="/payments/payment.php?country=bahrain&amount=4099"><button class="apply-button">Apply Now for $47.88 (₹3600 + ₹499) </button></a>
        </div>
