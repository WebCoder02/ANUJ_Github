                    ...
                    <td>
                        ...
                        <?php else: ?>
                            ...
                            <p>
                                ...
                                <a href="https://teyzeevisas.com/php/payment.php?country=Finland_Customer&amount=499" class="doc-link-special">Check Eligibility</a><br>
                                Pay ₹499 to check your visa eligibility and get free registration.<br>
                                After registration, you will receive your User ID and password on your registered Email ID.<br>
                                If you have already registered on TeyzeeVisas, please login:<br>
                                <a href="https://www.teyzeevisas.com/php/login.php?redirect_to=/php/Finland_Customer.php" class="doc-link-special">Login</a>
                            </p>
                        <?php endif; ?>
                    </td>
                </tr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Introduction letter by Indian company on a company letterhead mentioning purpose of visit and
                        relationship between the Indian and the Finnish company. 
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Finland- https://teyzee.com/finland.php; please type the 7 digit receipt no in your next whatsapp message to us`;
