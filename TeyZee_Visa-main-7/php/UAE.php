    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=uae&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        ...
        <div><strong>Processing Time:</strong> 3-4 working days</div>
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        <div><strong>Visa Type:</strong> eVisa</div>
        <div><strong>Processing Time:</strong> 3 to 4 working days</div>
        <div><strong>Visa Duration:</strong> 30 days from issue</div>
                ...
                <div class="process-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content result">
                            ...
                            <p>From the appointment date, get your visa in <span class="highlight">3-4 days</span>.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            ...
            <div class="info-grid">
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for United Arab Emirates</h3>
