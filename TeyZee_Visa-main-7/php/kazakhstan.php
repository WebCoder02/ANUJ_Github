...
<head>
    ...
    <title>TeyZee Visas - Kazakhstan Visa Services</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-text">
                    <h1>Get your Kazakhstan visa</h1>
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/kazakhstan.jpg" alt="Kazakhstan">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=kazakhstan&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="Croatia_/payments/payment.php?country=croatia&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Croatia_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
  ...
  <div class="visa-cards-grid">
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Kazakhstan Visa</h2>
            <p class="subtitle">Curated resources for Kazakhstan visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Kazakhstan Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Kazakhstan visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Kazakhstan Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Kazakhstan Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Kazakhstan. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Kazakhstan Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Kazakhstan</h3>
                        <p>Both single and multiple-entry visas available for Kazakhstan travel. <span
