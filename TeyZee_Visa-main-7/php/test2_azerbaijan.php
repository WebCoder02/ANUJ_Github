    ...
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Apply for Visa with TeyzeeVisa @ ₹499</h2>
                <a href="/payments/payment.php?country=azerbaijan&amp;amount=499" class="check-btn">Visa Service Fee @ ₹499</a>
            </div>
             <div class="label-container">
    ...
    <section class="next-appointment">
        ...
        <div class="container">
            ...
            <div class="visa-card business">
                <div class="visa-info">
                    <div class="visa-type">
                        <span class="heading" id="business-visa">Tourist</span>
                        <h3>90 Days</h3>
                        <p>Express Entry</p>
                    </div>
...
<section class="visa-cards-wrapper">
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <a href="/payments/payment.php?country=egypt&amount=499"><button class="apply-button">Apply Now @ $33.86$ (₹2899)</button></a>
    </div>
    ...
    <div class="visa-cards">
      ...
      <a href="/payments/payment.php?country=egypt&amount=499"><button class="apply-button">Apply Now @ $79.41$ (₹6799) </button></a>
    </div>
