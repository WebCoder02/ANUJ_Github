...
<head>
    ...
    <title>TeyZee Visas - Georgia Visa Services</title>
...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=georgia&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=georgia&amp;amount=499" class="check-btn">Download Documents</a>
    ...
    <h2 class="visa-information-title">eVisa Information</h2>
        ...
        <div class="visa-cards-grid">
            ...
            <a href="/payments/payment.php?country=georgia&amount=2299"><button class="apply-button">Apply Now for $21 (₹1800 + ₹499)</button></a>
            </div>
        </div>
    </section>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Georgia Visa</h2>
            <p class="subtitle">Curated resources for Georgia visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Georgia Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Georgia visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Georgia Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Georgia Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Georgia. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Georgia Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Georgia</h3>
                        <p>Both single and multiple-entry visas available for Georgia travel. <span
