...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment_visas.php?country=saudiArabia&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/payments/payment.php?country=saudiArabia&amp;amount=499" class="check-btn">Download Documents</a>
    ...
    <section class="visa-types">
        <div class="container">
            <h2>Types of Saudi Arabia Visa</h2>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            ...
            <div class="info-grid">
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for Saudi Arabia</h3>
