                ...
                <tr>
                 ...
                 <tr>
                        ...
                        <td>
                            <?php if (isset($_SESSION['user_id'])): ?>
                            <!-- Special links for logged-in users -->
                            <a class="doc-link-special" href="https://consmumbai.esteri.it/wp-content/uploads/2024/07/VISA-APPLICATION-FORM-ENGLISH.pdf">Download Application Form</a>
                            <a class="doc-link-special" href="https://visa.vfsglobal.com/one-pager/italy/india/mumbai/english/pdf/requisite_documents_for_tourist_visa.pdf">Download Document Checklist</a>
                            <?php else: ?>
