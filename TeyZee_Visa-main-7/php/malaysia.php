...
<head>
    ...
    <title>TeyZee Visas - Malaysia Visa Services</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/malaysia.jpg" alt="Malaysia">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=malaysia&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=malaysia&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Malaysia_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      <h3 class="visa-title">Single Entry (Digital Arrival Card)</h3>
      <div class="visa-information">
        <div><strong>Visa Type:</strong> DAC</div>
        <div><strong>Processing Time:</strong> 1 working days</div>
        <div><strong>Visa Duration:</strong> 30 Days</div>
        <div><strong>Length of Stay:</strong> Up to 30 days</div>
        
      </div>
      <a href="/payments/payment.php?country=malaysia&amount=499"><button class="apply-button">Apply Now for 0$ (+₹499)</button></a>
    </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Malaysia Visa</h2>
            <p class="subtitle">Curated resources for Malaysia visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Malaysia Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Malaysia visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Malaysia Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Malaysia Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Malaysia. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Malaysia Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Malaysia</h3>
                        <p>Both single and multiple-entry visas available for Malaysia travel. <span
