...
<head>
    ...
    <title>TeyZee Visas - Philippines Visa Services</title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-text">
                    <h1>Get your Philippines visa</h1>
            ...
            <div class="hero-image">
                <img src="../VisaImages/destinations/philippines.jpg" alt="Philippines">
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=phillippines&amount=499"><button class="check-btn">Visa Service Fee - Pay Rs 499</button></a>
            </div>
        </div>
    </section>
    <!-- <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                <h2>Visa Assistance for Rs 499/- only</h2>
                <a href="/payments/payment.php?country=philippines&amp;amount=499" class="check-btn">Download Documents</a>
                <h3>Get Access to Original Visa Form and Checklist</h3>
            </div>
            <!-- <div class="label-container">
                <h2 class="document-checklist">Document Checklist</h2>
                <a href="Philippines_Customer.html" target="_blank">Download the Documentation</a>
            </div> 
  ...
  <div class="visa-cards-grid">
    ...
    <div class="visa-cards">
      ...
      <div class="visa-information">
        ...
        <div><strong>Processing Time:</strong> 30 working days</div>
        <div><strong>Visa Duration:</strong> 90 days from issue</div>
        <div><strong>Length of Stay:</strong> Up to 30 days</div>
        
      </div>
      <a href="/payments/payment.php?country=philippines&amount=6219"><button class="apply-button">Apply Now for $72.41 (₹5,720 + ₹499)</button></a>
    </div>
                ...
                <div class="process-steps">
                    ...
                    <div class="step">
                        ...
                        <div class="step-content result">
                            ...
                            <p>From the appointment date, get your visa in <span class="highlight">30 days</span>.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Philippines Visa</h2>
            <p class="subtitle">Curated resources for Philippines visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Philippines Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Philippines visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Philippines Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Philippines Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Philippines. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Philippines Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry  Visas for Philippines</h3>
                        <p>Both single and multiple-entry visas available for Philippines travel. <span
