    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="S/payments/payment_visas.php?country=slovakia&amount=499"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    <section class="document-checklist">
        <div class="container">
            <div class="label-container">
                ...
                <a href="Slovakia_Customer.html" target="_blank">Download the Documentation</a>
            </div>
            <!-- <div class="label-container">
