...
<head>
    ...
    <title>TeyZee Visas - Austria Visa Services</title>
...
<body>
    ...
    <section class="visa-eligibility" id="document-checklist">
        <div class="container eligibility-container">
            <div class="eligibility-content">
                ...
                <a href="/payments/payment.php?country=austria&visa_type=eligibility_check&redirect_to=/php/austria.php"><button class="check-btn">Check Eligibility - Pay ₹499</button></a>
            </div>
        </div>
    </section>
    <section class="document-checklist">
        <div class="container">
             <div class="label-container">
                ...
                <a href="/php/Austria_Customer.php" class="check-btn">Download Documents</a>
        ...
        <div class="container">
            ...
            <div class="visa-card business">
                ...
                <div class="visa-action">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="/payments/payment.php?country=austria&visa_type=business"><button class="start-btn">Apply Now</button></a>
                    <?php else: ?>
                        <a href="/payments/payment.php?country=austria&visa_type=business&redirect_to=/php/austria.php"><button class="start-btn">Apply Now</button></a>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <section class="info-cards" id="info-section">
        <div class="container">
            <h2>Know more about Austria Visa</h2>
            <p class="subtitle">Curated resources for Austria visa</p>
            <div class="info-grid">
                <div class="info-card">
                    <div class="card-content">
                        <h3>Austria Visa Rejection Rates & Prevention Tips</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>How do I prevent my Austria visa application from being denied?</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>When to Apply for a Austria Visa: Optimal Timing</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Austria Transit Visa Requirements for Indian Citizens</h3>
                        <p>Indian citizens need a transit visa for all layovers in Austria. <span
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Reapplying After Austria Visa Rejection: Next Steps</h3>
                ...
                <div class="info-card">
                    <div class="card-content">
                        <h3>Single vs. Multiple-Entry Schengen Visas for Austria</h3>
                        <p>Both single and multiple-entry visas available for Austria travel. <span
