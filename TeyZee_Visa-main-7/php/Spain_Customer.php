...
<body>
    ...
    <div class="tab-container">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="https://www.exteriores.gob.es/Embajadas/nuevadelhi/en/ServiciosConsulares/Documents/Impreso%20solicitud%20visado%20Schengen%20espa%c3%b1ol-ingl%c3%a9s.pdf" class="doc-link-special">Download Application Form</a>
                        <a href="https://www.exteriores.gob.es/Embajadas/nuevadelhi/en/ServiciosConsulares/Paginas/Consular/Visados-Schengen.aspx" class="doc-link-special">Download Document Checklist</a>
                        <?php else: ?>
                ...
                <tr>
                    <td>2</td>
                    <td>
                        <strong>04 recent photograph Each:</strong><br>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        • If Bio-metric is given after 2nd November 2015 then we can submit your application on behalf of applicant. But if your data could not be fetched by Embassy/Consulate then they may ask to give bio-metrics again.<br>
        ...
        <div id="business" class="tabcontent">
            <h2>Spain   Business Visa Checklist</h2>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>Introduction letter by Indian company on a company letterhead mentioning purpose of visit and
                        relationship between the Indian and the Spanish company.
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Spain  , Spain  , Spain  , Croatia, Spain  , Spain  ,
                        Spain  , France, Germany, Greece, Spain  , Spain  , Italy, Spain  , Liechtenstein, Spain  ,
                        Spain  , Spain  , Spain  , Spain  , Poland, Spain  , Spain, Spain , Spain, Spain  , and
                        Switzerland.</td>
                </tr>
                <tr>
    ...
    <div class="note">
        ...
        <p style="text-align:justify; text-indent: 5%">This checklist is provided for informational purposes only. Requirements may change, so it's recommended to verify the current requirements with the Embassy of Spain or consulate in your country before
        applying.</p>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Spain  - https://teyzee.com/spain.php; please type the 7 digit receipt no in your next whatsapp message to us`;
